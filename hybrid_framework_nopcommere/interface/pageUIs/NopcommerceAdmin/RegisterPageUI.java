...
public class RegisterPageUI {
	...
	public static final String EXISTINGEMAIL_ERROR_MESSAGE = "//div[@class='message-error validation-summary-errors']//li";
	public static final String REGISTRATION_SUCCESS_MESSAGE = "//div[@class='page registration-result-page']//div[@class='result']";
