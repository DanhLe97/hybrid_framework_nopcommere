...
public class RegisterPageUI {
	...
	public static final String EXISTINGEMAIL_ERROR_MESSAGE = "xpath=//div[@class='message-error validation-summary-errors']//li";
	public static final String REGISTRATION_SUCCESS_MESSAGE = "xpath=//div[@class='page registration-result-page']//div[@class='result']";
