...
public class RegisterPageUI {
	...
	public static final String TXT_EMAIL="//li//input[@type='email']";
	...
	public static final String CHECKBOX_SIGNUP_NEWSLETTER="//li[@class='control']//label[@for='is_subscribed']";
	public static final String BTT_REGISTER="xpath=//button[@title='Register']";
	public static final String DYNAMIC_TXT_BY_NAME="xpath=//input[@id='%s']";
}